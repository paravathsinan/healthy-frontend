...
export default function HeroCarousel() {
  ...
  if (loading) {
    return (
      <div className="w-full h-[550px] md:h-[650px] bg-gray-50 animate-pulse flex items-center justify-center relative overflow-hidden rounded-b-[2rem]">
        <div className="max-w-4xl w-full px-4 space-y-8 flex flex-col items-center">
          {/* Title Skeleton */}
          <div className="h-10 md:h-16 bg-gray-200 rounded-2xl w-3/4 md:w-2/3 mx-auto" />
