...
function NewArrivalProductsContent() {
      ...
      <div className="space-y-8">
        <div className="flex justify-between items-end">
          <div className="space-y-0.5">
            ...
            <p className="text-[13px] text-gray-500 font-medium max-w-md">Manage products currently highlighted in the &quot;What&apos;s New&quot; section of your storefront.</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <CategoryFilter currentCategory={categorySlug} basePath="/admin/products/new" />
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden min-h-[500px]">
          {loading ? (
            ...
            <AdminProductTable products={filteredProducts} categories={categories} onSuccess={fetchNewArrivals} />
            ...
            <div className="flex flex-col items-center justify-center h-[500px] text-center space-y-4">
              ...
              <div className="space-y-1">
                <p className="text-lg font-bold text-gray-900">No new arrivals</p>
                <p className="text-gray-400 text-xs">Mark products as &quot;New Arrival&quot; to see them here.</p>
              </div>
        ...
        <ProductModal 
          ...
          onSuccess={fetchNewArrivals}
          categories={categories}
          defaultNewArrival={true}
        />
