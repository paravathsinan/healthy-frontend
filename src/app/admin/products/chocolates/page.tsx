        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-4">
          ...
          <div className="flex flex-row items-center gap-2 sm:gap-3 w-full md:w-auto">
            ...
            <button 
              ...
              className="bg-[#006837] text-white px-4 sm:px-6 py-2.5 rounded-full text-[13px] font-bold hover:bg-black transition-all shadow-md shadow-[#006837]/10 flex items-center justify-center gap-2 active:scale-95 whitespace-nowrap shrink-0"
            >
              <Plus className="h-4 w-4" />
              <span className="hidden sm:inline">Add Chocolate</span>
