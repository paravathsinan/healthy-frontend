...
export default async function AllProductsPage() {
  ...
  // Include category data so the category filter works
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white">
      <div className="mb-10 md:mb-16">
        <h1 className="text-2xl md:text-4xl text-gray-900 tracking-tight">All Products</h1>
      </div>

      <ProductsClientPage products={sanitizedProducts} />
